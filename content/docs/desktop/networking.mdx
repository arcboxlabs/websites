...
ArcBox automatically adapts when Surge or another VPN owns the container network's preferred route. See [VPN Compatibility](./vpn-compatibility) for the routing behavior, Surge configuration, verification steps, and remaining overlap limitations.
