...
Today we're releasing the public beta of ArcBox Desktop, a Docker Desktop alternative for macOS with free commercial use. The runtime is written in Rust. The desktop app is native SwiftUI. The code is open source under MIT/Apache-2.0.
...
OrbStack showed that running Docker on Mac can be much faster and lighter. But it's closed-source and paid for business and commercial use.
