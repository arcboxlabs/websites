...
const socialLinks = [
  { name: 'X', href: 'https://x.com/arcboxdev', icon: XIcon },
...
const footerLinks = [
  {
    ...
    links: [
      ...
      { name: 'Changelog', href: 'https://github.com/arcbox/releases' }
    ]
  },
  {
    title: 'Resources',
    links: [
      { name: 'Documentation', href: 'https://docs.arcbox.dev' },
      { name: 'Quick Start', href: 'https://docs.arcbox.dev/quickstart' },
      { name: 'API Reference', href: 'https://docs.arcbox.dev/api' },
      { name: 'Examples', href: 'https://github.com/arcbox/examples' }
    ]
  },
  {
    title: 'Company',
